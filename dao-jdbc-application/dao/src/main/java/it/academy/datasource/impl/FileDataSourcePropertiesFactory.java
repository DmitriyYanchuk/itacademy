package it.academy.datasource.impl;

import it.academy.datasource.DataSourcePropertiesFactory;
import it.academy.datasource.DataSourcePropertiesFactoryException;
...
public class FileDataSourcePropertiesFactory implements DataSourcePropertiesFactory {
    ...
    private static Reader getResource(final String source) throws DataSourcePropertiesFactoryException {
        final InputStream in = FileDataSourcePropertiesFactory.class.getClass().getClassLoader().getResourceAsStream(source);
        if (in != null) {
